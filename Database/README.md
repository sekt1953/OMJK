...
* [Database server installation](./DatabaseServerInstallation/README.md)
  * [kilder](./DatabaseServerInstallation/README.md#kilder)
  * [libreoffice-base](./DatabaseServerInstallation/README.md#libreoffice-base)
  * [setup-a-raspberry-pi-mariadb-database](./DatabaseServerInstallation/README.md#setup-a-raspberry-pi-mariadb-database)
    * [ssh-to-database-server](./DatabaseServerInstallation/README.md#ssh-to-database-server)
    * [creating-a-mysql-database-and-user](./DatabaseServerInstallation/README.md#creating-a-mysql-database-and-user)
    * [create-remote-user](./DatabaseServerInstallation/README.md#create-remote-user)
    * [test-remote-user](./DatabaseServerInstallation/README.md#test-remote-user)
