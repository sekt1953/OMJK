...
* ESPHome files:
  * [ESPHome's Secrets Files:](./esphome.md#secretsyaml)
    * [secrets.yaml](/HomeAssistant/ESPHome/secrets.yaml)
  * Leddriver Files:
    * [ESPHome files:](./esphome.md#leddriver)
  ...
  * [OccupiedSensor Files:](./esphome.md#occupied-xxyaml)
    * ESPHome Files:
